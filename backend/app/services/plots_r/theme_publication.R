...
theme_publication <- function(base_size = 11, title_size = 16, axis_label_size = 12,
  ...
  t <- theme_classic(base_size = base_size, base_family = font_family) +
    theme(
      plot.title = element_text(size = title_size, face = if (title_bold) "bold" else "plain", hjust = 0, margin = margin(b = 8), family = font_family),
      ...
      axis.text = element_text(size = base_size, color = "#374151", family = font_family),
      axis.text.x = element_text(size = x_label_info$size, angle = x_label_info$angle, hjust = x_label_info$hjust, margin = margin(t = 5), family = font_family),
      axis.text.y = element_text(size = y_label_info$size, angle = y_label_info$angle, hjust = y_label_info$hjust, margin = margin(r = 5), family = font_family),
      ...
      axis.line = element_line(colour = "#1f2937", linewidth = 0.35),
      axis.ticks = element_line(colour = "#1f2937", linewidth = 0.25),

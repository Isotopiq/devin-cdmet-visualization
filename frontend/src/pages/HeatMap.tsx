...
export default function HeatMap() {
  ...
  const generate = async () => {
    ...
    const res = await generatePlot(Number(projectId), Number(datasetId), { plot_type: 'heatmap', parameters: {} })
    setFigure(res.data)
  }

  return (
    <div>
      <h1 className="text-2xl font-bold mb-4 text-gray-900 dark:text-white">Heat Map</h1>
